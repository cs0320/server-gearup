...
// *
// * Using records where possible, because they provide a nice auto-definition of equals, toString,
// etc.
// * They are also immutable. Since they are classes, they can implement interfaces. But, since they
// are
// * classes that extend Record, they cannot extend other classes (since Java has no multiple
// inheritance).
// *
// * We'll create instances of this class via Moshi. Importantly, because Moshi deserializes into
// fields,
...
//        // (Summing Scovilles is not a good way to compute spiciness in a real soup, but serves as
// an example.)
