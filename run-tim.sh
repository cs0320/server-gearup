...
# TN: I've changed the use of "Main" to "Server" for this review.

# Find Server.java. It should be in a package below your username package.
MAIN=$(ls src/main/java/edu/brown/cs/*/*/server/Server.java)
[ -z "$MAIN" ] && echo "You need a Server.java" && exit 1
...
# TODO: You must package your code in this way or it will not work
java -ea -cp "$TARGET$PATHSEP$CP" edu.brown.cs.student.main.server.Server "$@"